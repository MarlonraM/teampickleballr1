        ...
        <div style={styles.pageWrapper}>
            <div style={styles.container}>
                ...
                <footer style={styles.footer}>
                    Presentado por <img src="https://www.michelobultra.com/content/dam/brand_michelobultra/logos/michelob-ultra-logo.svg" alt="Michelob Ultra" style={styles.footerLogo} />
                </footer>
            </div>
        </div>
    );
